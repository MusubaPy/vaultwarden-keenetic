...
/// To use a custom shard hasher, construct a [`ShardedExpiringCacheBase`] directly via
/// [`ShardedExpiringCacheBase::builder()`].
...
where
    ...
    H: ShardHasher<K>,
{
    /// Return a builder for constructing a [`ShardedExpiringCacheBase`].
    ///
